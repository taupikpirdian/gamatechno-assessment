                ...
                <div class="card-body">
                    <table id="scroll-horizontal-v2" class="table nowrap align-middle" style="width:100%">
                        ...
                        <tr>
                            ...
                            <th>T-7 <label style="color: red">*</label></th>
                            <th>BA-BB <label style="color: red">*</label></th>
                            <th>BA-4 <label style="color: red">*</label></th>
                            <th>Nota Pendapat Assessment Medis <label style="color: red">*</label></th>
                            <th>Permohonan Assessment Terpadu <label style="color: red">*</label></th>
                            <th>Rekomendasi Hasil Tim Assessment Terpadu <label style="color: red">*</label></th>
                            <th>Surat Pernyataan Rehabilitas Tersangka <label style="color: red">*</label></th>
                            <th>Surat Jaminan Tersangka/Uang <label style="color: red">*</label></th>
                            <th>Nota Pendapat RJ <label style="color: red">*</label></th>
                            <th>SOP Form-07 <label style="color: red">*</label></th>
                            <th>RJ-1 <label style="color: red">*</label></th>
                            <th>RJ-3 <label style="color: red">*</label></th>
                            <th>RJ-33 <label style="color: red">*</label></th>
                        ...
                        <tbody>
                            @foreach($datas as $data)
                                <tr>
                                    ...
                                    <td>{{$data->pasal}}</td>
                                    <td>
                                        {{$data->institutionCategoryPart ? $data->institutionCategoryPart->name : "" }}
                                    </td>
                                    <td>{{$data->tahap_2}}</td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        @include('dashboard.component.row_template', [
                                            ...
                                            'dataLabel' => "BA-4", 
                                            'dataName' => "ba_4",
                                            'dataHref' => route('application.download', [$data->uuid, $data->fileBa4 ? $data->fileBa4->name : ""]),
                                            'fileName' => $data->fileBa4 ? $data->fileBa4->name : "",
                                            'fileCreatedAt' => $data->fileBa4 ? $data->fileBa4->created_at : "",
                                            'status' => $data->status,
                                            'modal' => "uploadModalUpdate"
                                        ])
                                    </td>
                                    <td class="text-center">
                                        @include('dashboard.component.row_template', [
                                            'uuid' => $data->uuid, 
                                            'dataLabel' => "Nota Pendapat Assessment Medis", 
                                            'dataName' => "nota_medis",
                                            'dataHref' => route('application.download', [$data->uuid, $data->fileNotaPendapatAssessmentMedis ? $data->fileNotaPendapatAssessmentMedis->name : ""]),
                                            'fileName' => $data->fileNotaPendapatAssessmentMedis ? $data->fileNotaPendapatAssessmentMedis->name : "",
                                            'fileCreatedAt' => $data->fileNotaPendapatAssessmentMedis ? $data->fileNotaPendapatAssessmentMedis->created_at : "",
                                            'status' => $data->status,
                                            'modal' => "uploadModalUpdate"
                                        ])
                                    </td>
                                    <td class="text-center">
                                        @include('dashboard.component.row_template', [
                                            'uuid' => $data->uuid, 
                                            'dataLabel' => "Permohonan Assessment Terpadu", 
                                            'dataName' => "permohonan_tim_asses_terpadu",
                                            'dataHref' => route('application.download', [$data->uuid, $data->filePermohonanAssessmentTerpadu ? $data->filePermohonanAssessmentTerpadu->name : ""]),
                                            'fileName' => $data->filePermohonanAssessmentTerpadu ? $data->filePermohonanAssessmentTerpadu->name : "",
                                            'fileCreatedAt' => $data->filePermohonanAssessmentTerpadu ? $data->filePermohonanAssessmentTerpadu->created_at : "",
                                            'status' => $data->status,
                                            'modal' => "uploadModalUpdate"
                                        ])
                                    </td>
                                    <td class="text-center">
                                        @include('dashboard.component.row_template', [
                                            'uuid' => $data->uuid, 
                                            'dataLabel' => "Rekomendasi Hasil Tim Assessment Terpadu", 
                                            'dataName' => "rekomendasi_hasil_tim_asses_terpadu",
                                            'dataHref' => route('application.download', [$data->uuid, $data->fileRekomendasiHasilTimAssessmentTerpadu ? $data->fileRekomendasiHasilTimAssessmentTerpadu->name : ""]),
                                            'fileName' => $data->fileRekomendasiHasilTimAssessmentTerpadu ? $data->fileRekomendasiHasilTimAssessmentTerpadu->name : "",
                                            'fileCreatedAt' => $data->fileRekomendasiHasilTimAssessmentTerpadu ? $data->fileRekomendasiHasilTimAssessmentTerpadu->created_at : "",
                                            'status' => $data->status,
                                            'modal' => "uploadModalUpdate"
                                        ])
                                    </td>
                                    <td class="text-center">
                                        @include('dashboard.component.row_template', [
                                            'uuid' => $data->uuid, 
                                            'dataLabel' => "Surat Pernyataan Rehabilitas Tersangka", 
                                            'dataName' => "sur_rehab_tersangka",
                                            'dataHref' => route('application.download', [$data->uuid, $data->fileSuratPernyataanRehabilitasTersangka ? $data->fileSuratPernyataanRehabilitasTersangka->name : ""]),
                                            'fileName' => $data->fileSuratPernyataanRehabilitasTersangka ? $data->fileSuratPernyataanRehabilitasTersangka->name : "",
                                            'fileCreatedAt' => $data->fileSuratPernyataanRehabilitasTersangka ? $data->fileSuratPernyataanRehabilitasTersangka->created_at : "",
                                            'status' => $data->status,
                                            'modal' => "uploadModalUpdate"
                                        ])
                                    </td>
                                    <td class="text-center">
                                        @include('dashboard.component.row_template', [
                                            'uuid' => $data->uuid, 
                                            'dataLabel' => "Surat Jaminan Tersangka/Uang", 
                                            'dataName' => "sur_jaminan",
                                            'dataHref' => route('application.download', [$data->uuid, $data->fileSuratJaminanTersangka ? $data->fileSuratJaminanTersangka->name : ""]),
                                            'fileName' => $data->fileSuratJaminanTersangka ? $data->fileSuratJaminanTersangka->name : "",
                                            'fileCreatedAt' => $data->fileSuratJaminanTersangka ? $data->fileSuratJaminanTersangka->created_at : "",
                                            'status' => $data->status,
                                            'modal' => "uploadModalUpdate"
                                        ])
                                    </td>
                                    ...
                                    <td class="text-center">
                                        @include('dashboard.component.row_template', [
                                            ...
                                            'dataLabel' => "RJ-1", 
                                            'dataName' => "rj_1",
                                            'dataHref' => route('application.download', [$data->uuid, $data->fileRj1 ? $data->fileRj1->name : ""]),
                                            'fileName' => $data->fileRj1 ? $data->fileRj1->name : "",
                                            'fileCreatedAt' => $data->fileRj1 ? $data->fileRj1->created_at : "",
                                            'status' => $data->status,
                                            'modal' => "uploadModalUpdate"
                                        ])
                                    </td>
                                    <td class="text-center">
                                        @include('dashboard.component.row_template', [
                                            ...
                                            'dataLabel' => "RJ-3", 
                                            'dataName' => "rj_3",
                                            'dataHref' => route('application.download', [$data->uuid, $data->fileRj3 ? $data->fileRj3->name : ""]),
                                            'fileName' => $data->fileRj3 ? $data->fileRj3->name : "",
                                            'fileCreatedAt' => $data->fileRj3 ? $data->fileRj3->created_at : "",
                                            'status' => $data->status,
                                            'modal' => "uploadModalUpdate"
                                        ])
                                    </td>
                                    <td class="text-center">
                                        @include('dashboard.component.row_template', [
                                            ...
                                            'dataLabel' => "RJ-33", 
                                            'dataName' => "rj_33",
                                            'dataHref' => route('application.download', [$data->uuid, $data->fileRj33 ? $data->fileRj33->name : ""]),
                                            'fileName' => $data->fileRj33 ? $data->fileRj33->name : "",
                                            'fileCreatedAt' => $data->fileRj33 ? $data->fileRj33->created_at : "",
                                            'status' => $data->status,
                                            'modal' => "uploadModalUpdate"
                                        ])
                                    </td>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                @hasanyrole('seksi-kejati')
                                                    ...
                                                    @if($data->status == "DIKIRIM")
                                                        <li><a href="#" class="dropdown-item revisionModal" data-id="{{ $data->uuid  }}" data-status="REVISI-PENERIMAAN" data-bs-toggle="modal" data-bs-target="#revisiModal"><i class="ri-close-line align-bottom me-2 text-muted"></i> Tolak</a></li>
                                                    @endif
                                                @endhasanyrole
                                            </ul>
                                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            new DataTable("#scroll-horizontal-v2", {
                scrollX: true,
                order: [[30, "desc"]] // This orders the first column in descending order
            });
        })
    </script>
                    ...
                    $.ajax({
                        ...
                        success: (data) => {
                            ...
                            Swal.fire({
                                ...
                                window.location.href = "{{URL::to('restorative-justice/accept?m=narkotika')}}"
                            });
                        },
                        error: function(data){
                            console.log(data);
