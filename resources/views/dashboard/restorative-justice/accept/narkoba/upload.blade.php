                ...
                <div class="card-body">
                    <form id="fileUploadForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label class="form-label red-bullet">BA-4</label>
                                    <input type="file" class="form-control bg-light border-light" id="ba_4" name="ba_4" onchange="validationFile('ba_4')" required/>
                                    <p class="text-danger">format file: .pdf max file 2Mb</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label class="form-label red-bullet">Nota Pendapat Assessment Medis</label>
                                    <input type="file" class="form-control bg-light border-light" id="nota_medis" name="nota_medis" onchange="validationFile('nota_medis')" required/>
                                    <p class="text-danger">format file: .pdf max file 2Mb</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label class="form-label red-bullet">Permohonan Tim Assessment Terpadu</label>
                                    <input type="file" class="form-control bg-light border-light" id="permohonan_tim_asses_terpadu" name="permohonan_tim_asses_terpadu" onchange="validationFile('permohonan_tim_asses_terpadu')" required/>
                                    <p class="text-danger">format file: .pdf max file 2Mb</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label class="form-label red-bullet">Rekomendasi Hasil Tim Assessment Terpadu</label>
                                    <input type="file" class="form-control bg-light border-light" id="rekomendasi_hasil_tim_asses_terpadu" name="rekomendasi_hasil_tim_asses_terpadu" onchange="validationFile('rekomendasi_hasil_tim_asses_terpadu')" required/>
                                    <p class="text-danger">format file: .pdf max file 2Mb</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label class="form-label red-bullet">Surat Pernyataan Rehabilitas Tersangka</label>
                                    <input type="file" class="form-control bg-light border-light" id="sur_rehab_tersangka" name="sur_rehab_tersangka" onchange="validationFile('sur_rehab_tersangka')" required/>
                                    <p class="text-danger">format file: .pdf max file 2Mb</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label class="form-label red-bullet">Surat Jaminan Keluarga Tersangka/Uang</label>
                                    <input type="file" class="form-control bg-light border-light" id="sur_jaminan" name="sur_jaminan" onchange="validationFile('sur_jaminan')" required/>
                                    <p class="text-danger">format file: .pdf max file 2Mb</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label class="form-label red-bullet">RJ-1</label>
                                    <input type="file" class="form-control bg-light border-light" id="rj_1" name="rj_1" onchange="validationFile('rj_1')" required/>
                                    <p class="text-danger">format file: .pdf max file 2Mb</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label class="form-label red-bullet">RJ-3</label>
                                    <input type="file" class="form-control bg-light border-light" id="rj_3" name="rj_3" onchange="validationFile('rj_3')" required/>
                                    <p class="text-danger">format file: .pdf max file 2Mb</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label class="form-label red-bullet">RJ-33</label>
                                    <input type="file" class="form-control bg-light border-light" id="rj_33" name="rj_33" onchange="validationFile('rj_33')" required/>
                                    <p class="text-danger">format file: .pdf max file 2Mb</p>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function (e) {
            ...
            $('#fileUploadForm').submit(function(e) {
                ...
                $.ajax({
                    type:'POST',
                    url: "{{ url('/restorative-justice/upload-file/narkotika/' . $data->uuid)}}",
                    data: formData,
                    cache:false,
                    contentType: false,
                    processData: false,
